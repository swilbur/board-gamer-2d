module.exports = {
  ...
  objects: [
...

    {
      ...
      width: 407,
      height: 154,
      snapZones: [{x: 0, width: 50, cellWidth: 50, cellHeight: 77},
                  {x: 51, width: 50, cellWidth: 50, cellHeight: 77},
                  {x: 102, width: 50, cellWidth: 50, cellHeight: 77},
                  {x: 153, width: 50, cellWidth: 50, cellHeight: 77},
                  {x: 204, width: 50, cellWidth: 50, cellHeight: 77},
                  {x: 255, width: 50, cellWidth: 50, cellHeight: 77},
                  {x: 306, width: 50, cellWidth: 50, cellHeight: 77},
                  {x: 357, width: 50, cellWidth: 50, cellHeight: 77}],
    },
